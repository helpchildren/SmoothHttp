package com.sesxh.smoothhttp.ssl;
...
public class SSLManager {
    ...
    private static final HostnameVerifier DEFAULT_HOST_NAME_VERIFIER= OkHostnameVerifier.INSTANCE;
    ...
    public static SSLSocketFactory getSslSocketFactory(InputStream[] certificates, InputStream bksFile, String
        ...
        try {
            ...
            if (trustManagers != null) {
                sX509TrustManager = new MyTrustManager(chooseTrustManager(trustManagers));
            } else {
                sX509TrustManager = new UnSafeX509TrustManager();
            }
            sslContext.init(keyManagers, new TrustManager[]{sX509TrustManager}, new SecureRandom());
    ...
    public static HostnameVerifier getDefaultHostNameVerifier() {
        return DEFAULT_HOST_NAME_VERIFIER;
    }
    ...
    public static class SafeHostnameVerifier implements HostnameVerifier {
        ...
        public boolean verify(String hostname, SSLSession session) {
            ...
            if (SmoothHttp.getInstance().globalConfig().isTrustAll()) return true;
